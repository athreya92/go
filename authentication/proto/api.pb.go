...
func init() {
	proto.RegisterType((*PingMessage)(nil), "interfaces.PingMessage")
}
...
func (c *pingClient) SayHello(ctx context.Context, in *PingMessage, opts ...grpc.CallOption) (*PingMessage, error) {
	out := new(PingMessage)
	err := grpc.Invoke(ctx, "/interfaces.Ping/SayHello", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Ping_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/interfaces.Ping/SayHello",
	}
...
var fileDescriptor0 = []byte{
	...
	0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0xca, 0xcc, 0x2b, 0x49, 0x2d, 0x4a, 0x4b, 0x4c, 0x4e,
	0x2d, 0x56, 0xd2, 0xe4, 0xe2, 0x0e, 0xc8, 0xcc, 0x4b, 0xf7, 0x4d, 0x2d, 0x2e, 0x4e, 0x4c, 0x4f,
	0x15, 0x92, 0xe2, 0xe2, 0x48, 0x2f, 0x4a, 0x4d, 0x2d, 0xc9, 0xcc, 0x4b, 0x97, 0x60, 0x54, 0x60,
	0xd4, 0xe0, 0x0c, 0x82, 0xf3, 0x8d, 0xdc, 0xb8, 0x58, 0x40, 0x4a, 0x85, 0xec, 0xb8, 0x38, 0x82,
	0x13, 0x2b, 0x3d, 0x52, 0x73, 0x72, 0xf2, 0x85, 0xc4, 0xf5, 0x10, 0x66, 0xe9, 0x21, 0x19, 0x24,
	0x85, 0x4b, 0x42, 0x89, 0x21, 0x89, 0x0d, 0xec, 0x0a, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff,
	0xdd, 0x51, 0xf7, 0x3c, 0x92, 0x00, 0x00, 0x00,
}
